...
export const sendBookingConfirmationEmail = async (booking, room) => {
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p class="tagline">Where the waves meet paradise</p>
        </div>
        ...
        <div class="content">
          ...
          <p>Thank you for choosing Fatwave Surf Resort. We are delighted to confirm your reservation.</p>
          ...
          <div class="details">
            ...
            <div class="detail-row">
              ...
              <span class="detail-value">${guestDisplay}</span>
            </div>
          ...
          <div class="contact">
            ...
            <p>Contact our team at any time.</p>
            <p>Email: reservations@fatwavesurfresort.com</p>
            <p>Website: fatwavesurfresort.com</p>
          </div>
        </div>
        
        <div class="footer">
          <p>Fatwave Surf Resort</p>
          <p>La Union, Philippines</p>
          <p>&copy; ${new Date().getFullYear()} Fatwave Surf Resort. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
  ...
  const mailOptions = {
    from:
      ...
      '"Fatwave Surf Resort" <noreply@fatwavesurfresort.com>',
    to: booking.guestEmail || booking.email,
...
export const sendNewBookingNotification = async (booking, room) => {
  ...
  const htmlContent = `
    ...
    <p><strong>Guests:</strong> ${guestDisplay}</p>
  ...
  const mailOptions = {
    from:
      process.env.EMAIL_FROM ||
      '"Fatwave System" <noreply@fatwavesurfresort.com>',
...
export const sendReceiptEmail = async (booking, room, pdfData) => {
  ...
  const htmlContent = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1 class="logo">Fatwave Surf Resort</h1>
          <p class="tagline">Where the waves meet paradise</p>
        </div>
        
        <div class="content">
          <h2 class="title">Booking Confirmation</h2>
          <p class="subtitle">Thank you for choosing Fatwave Surf Resort, ${booking.guestName}</p>
  ...
  const mailOptions = {
    from:
      ...
      '"Fatwave Surf Resort" <noreply@fatwavesurfresort.com>',
    to: booking.guestEmail || booking.email,
    subject: `Booking Confirmation – ${booking.bookingReference} | Fatwave Surf Resort`,
    html: htmlContent,
    attachments: [
      {
  ...
  try {
    const info = await transporter.sendMail(mailOptions);
    console.log("Receipt email sent with PDF:", info.messageId);
    return { success: true, messageId: info.messageId };
  } catch (error) {
